...
from namecheap_wrapper.schemas.base import APIResponse
from namecheap_wrapper.schemas.request.ssl import (
...
class SSLService:
    ...
    def re_send_approver_email(
        self, payload: ReSendApproverEmailRequest
    ) -> APIResponse[Dict]:
        """
    ...
    def revoke_certificate(
        self, payload: RevokeCertificateRequest
    ) -> APIResponse[Dict]:
        """
