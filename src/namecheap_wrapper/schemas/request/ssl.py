...
from namecheap_wrapper.schemas.base import APIRequest
...
class ActivateReissueOVRequest(BaseActivateCertificateRequest):
    ...
    organization_name: str = Field(
        ...,
        alias="AdminOrganizationName",
        description="Organization name for the SSL certificate",
    )
...
class ActivateReissueEVRequest(BaseActivateCertificateRequest):
    ...
    company_registration_number: str = Field(
        ...,
        alias="CompanyRegistrationNumber",
